...
#Step 5 - Extract DETs between Infertile and Fertile
...
#Step 6 - Filter and plot significant DETs
sig_res <- res %>%
...
EnhancedVolcano(res, lab = rownames(res),
                ...
                title = "Bulk DETs - Infertile vs Fertile", titleLabSize = 25,
                subtitle = NULL,
                colCustom = keyvals,
...
ggplot(pca_df, aes(x = PC1, y = PC2, color = fertility, shape = cell_type)) +
  ...
  labs(
    title = "Pseudobulk PCA (fertility)",
